...
{
    public class FixedUpdateVariables : MonoBehaviour
    {

        internal static class FixedUpdateVariablesStatic<T>
        {
        ...
        {
            var (result, clearAction) = FixedUpdateVariablesStatic<T>.Get(definition.Variable, definition.Getter);
        ...
        {
            var clearAction = FixedUpdateVariablesStatic<T>.Set(variableName, value);
            _clearActions[typeof(T)] = clearAction;
        }
    }
}